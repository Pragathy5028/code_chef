// CodeChef recently revamped its practice page,
// to make it easier for users to identify the next problems they should solve by introducing some new features:
